      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
                onPressed: () {}, child: Text(songs.selectedArtist.toString()))
          ],
        ),
        Expanded(
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(songs.songs[index].title.length < 20
                                  ? songs.songs[index].title
                                  : songs.songs[index].title.substring(0, 20)),
                              // Text(file.genre.toString()),
                              Text(songs.songs[index].artist),
                              // Text(file.discTotal.toString()),
                              Text(songs.songs[index].year.toString())
                            ],
                          ),
                        ),
                      ),
