...
class ColorSelectorAlert extends ConsumerWidget {
  @override
  ...
  Widget _buildColorButton(BuildContext context, WidgetRef ref,
      ColorScheme scheme, ColorScheme currentScheme) {
